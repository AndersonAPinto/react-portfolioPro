    ...
    return (
        <div className="container__Experience">
            <div className="title_experience">
                <h1 style={{}}><HiArrowDownRight />Experiências</h1>
            </div>
            ...
            <div>
                <div className="imgs_site" >
                    <p style={{ fontSize: '1.3em', marginLeft:'5px' }}>
                        ...
                        App em Desenvolvimento de backend, construido com Figma, e desenvolvido com React Native, o app trará a solução adequada para o problema, futuramente estará presente na Google Play com o mesmo nome do título. 
                    </p>
                    <img src={App_1} style={{ width: '25%', height: '450px', marginLeft: '75px', borderRadius: '10px' }} />
                </div>
            </div>
            <hr style={{ margin: '25px', width: '70vw' }} />
            <div>
            ...
            <div>
                <div className="imgs_site" >
                    <p style={{ fontSize: '1.3em' }}>
                        <h6 style={{ color: '#C68107', justifyContent:'end' }}>Teste de Inglês</h6>
                        ...
                        <a  href="https://testedeingles.app.br/" target="_blank" rel="noopener noreferrer" style={{color:'#ff6b08'}}> Saiba mais</a>
                    </p>
